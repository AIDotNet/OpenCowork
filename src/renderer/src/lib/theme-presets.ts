...
export const DEFAULT_SSH_TERMINAL_THEME_PRESET: SshTerminalThemePreset = 'mulberry'
  ...
  mulberry: {
    ...
    cssVars: {
      light: {
        ...
        '--sidebar-ring': '#a1a1aa',
        '--workspace-titlebar-bg': '#fafafa',
        '--workspace-titlebar-border': '#e4e4e7',
        '--workspace-titlebar-button-hover': '#f4f4f5',
        '--workspace-titlebar-toolgroup-bg': '#ffffff',
        '--workspace-titlebar-toolgroup-border': '#e4e4e7',
        '--workspace-titlebar-toolbutton-hover': '#f4f4f5',
        '--workspace-titlebar-toolbutton-active': '#ededf0',
        '--workspace-sidebar-divider': '#e4e4e7',
        '--workspace-sidebar-section-border': '#e4e4e7',
        '--workspace-sidebar-row-hover-bg': '#f4f4f5',
        '--workspace-sidebar-row-hover-border': '#e4e4e7',
        '--workspace-sidebar-row-active-bg': '#ededf0',
        '--workspace-sidebar-row-active-border': '#d4d4d8',
        '--workspace-sidebar-row-active-shadow': '0 10px 18px -16px rgba(24, 24, 27, 0.12)',
        '--activity-card-bg': '#ffffff',
        '--activity-card-border': '#e4e4e7',
        '--activity-card-divider': '#ececf0',
        '--activity-card-header-hover': '#f4f4f5',
        '--activity-card-shadow': '0 14px 28px -22px rgba(24, 24, 27, 0.12)',
        '--composer-shell-top': '#ffffff',
        '--composer-shell-bottom': '#fafafa',
        '--composer-shell-border': '#e4e4e7',
        '--composer-shell-border-focus': 'color-mix(in srgb, #a1a1aa 28%, #e4e4e7)',
      ...
      dark: {
        ...
        '--sidebar-ring': '#71717a',
        '--workspace-titlebar-bg': '#111113',
        '--workspace-titlebar-border': '#27272a',
        '--workspace-titlebar-button-hover': '#27272a',
        '--workspace-titlebar-toolgroup-bg': '#18181b',
        '--workspace-titlebar-toolgroup-border': '#2a2a2e',
        '--workspace-titlebar-toolbutton-hover': '#27272a',
        '--workspace-titlebar-toolbutton-active': '#323237',
        '--workspace-sidebar-divider': '#27272a',
        '--workspace-sidebar-section-border': '#27272a',
        '--workspace-sidebar-row-hover-bg': '#27272a',
        '--workspace-sidebar-row-hover-border': '#323237',
        '--workspace-sidebar-row-active-bg': '#323237',
        '--workspace-sidebar-row-active-border': '#3f3f46',
        '--workspace-sidebar-row-active-shadow': '0 14px 24px -22px rgba(0, 0, 0, 0.32)',
        '--activity-card-bg': '#18181b',
        '--activity-card-border': '#27272a',
        '--activity-card-divider': '#2a2a2e',
        '--activity-card-header-hover': '#212124',
        '--activity-card-shadow': '0 18px 32px -24px rgba(0, 0, 0, 0.36)',
        '--composer-shell-top': '#18181b',
        '--composer-shell-bottom': '#141416',
        '--composer-shell-border': '#2a2a2e',
        '--composer-shell-border-focus': 'color-mix(in srgb, #71717a 28%, #2a2a2e)',
        '--composer-shell-shadow':
  ...
  graphite: {
    ...
    cssVars: {
      ...
      dark: {
        ...
        '--sidebar-accent': '#252b30',
        '--sidebar-accent-foreground': '#f5f8f7',
        '--sidebar-border': '#353d41',
        '--sidebar-ring': '#86ddd1',
        '--workspace-titlebar-bg': '#1b1f24',
        ...
        '--composer-shell-top': '#23282d',
        '--composer-shell-bottom': '#1f2429',
