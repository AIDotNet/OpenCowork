...
export const DB_SESSION_COMPACTION_GET_MSGPACK_CHANNEL = 'db:session-compaction:get:msgpack'
export const DB_SESSION_COMPACTION_COMMIT_MSGPACK_CHANNEL = 'db:session-compaction:commit:msgpack'
